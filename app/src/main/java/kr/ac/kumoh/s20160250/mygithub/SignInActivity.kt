...
import kr.ac.kumoh.s20160250.mygithub.databinding.ActivitySignInBinding
import kr.ac.kumoh.s20160250.mygithub.utillity.AuthTokenProvider
    ...
    private suspend fun getAccessToken(code: String) = withContext(Dispatchers.IO) {
        ...
        if (response.isSuccessful) {
            ...
            if(accessToken.isNotEmpty()){
                ...
                Toast.makeText(this@SignInActivity, "accessToken 이 존재하지않습니다", Toast.LENGTH_SHORT).show()
            }
        }
    }
}